    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            As collections, variants, and sales channels grow, your templates and workflows scale with you. Layout quality becomes consistent and repeatable instead of relying on manual fixes.
          </p>
