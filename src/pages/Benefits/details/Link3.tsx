    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Build reusable templates for product pages, collection overviews, and spec sheets. Update images, descriptions, and pricing quickly as collections evolve without redesigning from scratch.
          </p>
