    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Prepare documents that print cleanly and look sharp on screens, from large catalogues to email-ready PDFs. Confidence in output quality ensures consistent presentation across all channels.
          </p>
