    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            High-quality publications make each jewellery piece feel part of a premium brand universe. This perception supports stronger positioning, better margins, and long-term customer trust.
          </p>
