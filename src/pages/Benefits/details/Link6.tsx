    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Use consistent layouts, imagery, and messaging across printed catalogues, event brochures, and digital PDFs. Customers experience a unified brand whether online, in-store, or at events.
          </p>
