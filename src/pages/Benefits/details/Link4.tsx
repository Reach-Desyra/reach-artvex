    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Structure information so buyers see exactly what they need—visuals, specs, and pricing at a glance. Well-organised documents reduce confusion, speed up buying decisions, and support smoother business interactions.
          </p>
