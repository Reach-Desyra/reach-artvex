...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Artvex", path: "/about" },
    { label: "Benefits of REACH Artvex", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    // { label: "REACH Print Studio Images", path: "/rmmimages" },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block w-fit">
              <span className="text-primary">REACH</span> Artvex
            </Link>
